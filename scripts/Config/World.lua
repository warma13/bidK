...
M.REGIONS = {
    ...
    -- ── 区域7：深海打捞站（500万门槛，8仓库）──────────────────────────
    {
        ...
        icon = "image/warehouse_shipwreck_20260328210723.jpg",
    ...
    -- ── 区域8：顶级私产托管区（1000万门槛，8仓库）─────────────────────
    {
        id = "private", name = "顶级私产托管区",
        ...
        difficulties = {
            {
                level = "private", label = "1000万场",
                entryFee = 200000,
                startingMoney = 60000000,
...
M.WAREHOUSE_TYPES = {
    ...
    suburb_unknown = {
        ...
        icon = "image/icon_unknown_warehouse.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    suburb_basement = {
        ...
        icon = "image/icon_suburb_basement.png", bg = "image/bg_warehouse_grocery_20260322132513.jpg",
    ...
    suburb_supermarket = {
        ...
        icon = "image/icon_suburb_supermarket.png", bg = "image/bg_warehouse_grocery_20260322132513.jpg",
    ...
    suburb_recycling = {
        ...
        icon = "image/icon_suburb_recycling.png", bg = "image/bg_warehouse_grocery_20260322132513.jpg",
    ...
    suburb_hardware = {
        ...
        icon = "image/icon_suburb_hardware.png", bg = "image/bg_warehouse_grocery_20260322132513.jpg",
    ...
    ind_unknown = {
        ...
        icon = "image/icon_unknown_warehouse.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    ind_autoparts = {
        ...
        icon = "image/icon_ind_autoparts.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    ind_building = {
        ...
        icon = "image/icon_ind_building.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    ind_machinery = {
        ...
        icon = "image/icon_ind_machinery.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    ind_ewaste = {
        ...
        icon = "image/icon_ind_ewaste.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    ind_appliance = {
        ...
        icon = "image/icon_ind_appliance.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    ind_unclaimed = {
        ...
        icon = "image/icon_ind_unclaimed.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    com_department = {
        ...
        icon = "image/icon_com_department.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 28, 26, 24, 14, 8 },
    ...
    com_brandclear = {
        ...
        icon = "image/icon_com_brandclear.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 25, 27, 25, 15, 8 },
        categoryWeights = { fashion = 30, art = 25, jewel = 22, daily = 15, antique = 8 },
        preferredTags = { streetwear = 2.0 },
    },
    com_superstore = {
        name = "连锁超市配送中心",
        desc = "连锁超市关闭的区域配送中心，日用百货、食品包装物料与促销赠品堆满整仓，急需出清",
        icon = "image/icon_com_superstore.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 30, 28, 22, 13, 7 },
    ...
    com_jewelry = {
        ...
        icon = "image/icon_com_jewelry.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 28, 26, 24, 14, 8 },
    ...
    com_sports = {
        ...
        icon = "image/icon_com_sports.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 30, 28, 22, 13, 7 },
        categoryWeights = { daily = 45, transport = 22, mechanical = 18, fashion = 10, tech = 5 },
        preferredTags = { streetwear = 3.0 },
    },
    com_imports = {
        name = "进口食品代理商仓库",
        desc = "进口食品代理商的清仓库，洋酒、零食与特色食材堆叠其中，偶有限量版礼盒混入其中",
        icon = "image/icon_com_imports.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 32, 28, 20, 13, 7 },
    ...
    com_furniture = {
        ...
        icon = "image/icon_com_furniture.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    com_cosmetics = {
        ...
        icon = "image/icon_com_cosmetics.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 32, 28, 20, 13, 7 },
    ...
    port_unknown = {
        ...
        icon = "image/icon_unknown_warehouse.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
    ...
    port_customs = {
        ...
        icon = "image/icon_port_customs.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
        sizeWeights = { 20, 23, 26, 18, 13 },
    ...
    port_container = {
        ...
        icon = "image/icon_port_container.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
        sizeWeights = { 18, 22, 28, 20, 12 },
    ...
    port_unclaimed = {
        ...
        icon = "image/icon_port_unclaimed.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
    ...
    port_bonded = {
        ...
        icon = "image/icon_port_bonded.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
    ...
    port_coldchain = {
        ...
        icon = "image/icon_port_coldchain.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
    ...
    port_artship = {
        ...
        icon = "image/icon_port_artship.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
    ...
    port_yacht = {
        ...
        icon = "image/icon_port_yacht.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
    ...
    port_auction = {
        ...
        icon = "image/icon_port_auction.png", bg = "image/bg_warehouse_bondedport_20260323082731.jpg",
    ...
    tech_incubator = {
        ...
        icon = "image/icon_tech_incubator.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    tech_quantum = {
        ...
        icon = "image/icon_tech_quantum.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
        sizeWeights = { 15, 18, 27, 25, 15 },
        categoryWeights = { tech = 52, energy = 22, mechanical = 14, biotech = 8, art = 4 },
        preferredTags = { precision_optics = 3.0, semiconductor = 2.0, research_instrument = 2.0 },
    },
    tech_semiconductor = {
        name = "半导体工厂余料仓",
        desc = "半导体生产线停产后遗留的余料仓，晶圆碎片、芯片模组与精密检测设备堆满整个货架",
        icon = "image/icon_tech_semiconductor.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
        sizeWeights = { 20, 22, 26, 20, 12 },
    ...
    tech_medical = {
        ...
        icon = "image/icon_tech_medical.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
        sizeWeights = { 22, 23, 26, 18, 11 },
        categoryWeights = { tech = 35, mechanical = 28, energy = 20, biotech = 12, daily = 5 },
        preferredTags = { research_instrument = 2.5 },
    },
    tech_newenergy = {
        name = "新能源车零件仓",
        desc = "新能源汽车配件供应商的库存清仓仓，电池模组、驱动电机与充电桩核心组件大量堆积",
        icon = "image/icon_tech_newenergy.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
        sizeWeights = { 18, 20, 26, 23, 13 },
    ...
    tech_aerospace = {
        ...
        icon = "image/icon_tech_aerospace.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
    ...
    tech_datacenter = {
        ...
        icon = "image/icon_tech_datacenter.png", bg = "image/bg_warehouse_datacenter_20260322132508.jpg",
        sizeWeights = { 18, 20, 26, 23, 13 },
    ...
    tech_university = {
        ...
        icon = "image/icon_tech_university.png", bg = "image/bg_warehouse_techpark_20260322132509.jpg",
        sizeWeights = { 20, 22, 26, 20, 12 },
        categoryWeights = { tech = 38, energy = 22, mechanical = 18, art = 12, biotech = 10 },
        preferredTags = { research_instrument = 3.5 },
    },
    ...
    priv_unknown = {
        name = "神秘仓库",
        desc = "来历成谜的私密托管仓，委托人要求完全匿名，连经手律师都无法透露内容，唯有亲眼打开才能揭晓",
        icon = "image/icon_unknown_warehouse.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 10, 15, 25, 28, 22 },
        categoryWeights = { jewel = 28, art = 25, antique = 22, fashion = 15, tech = 10 },
    },
    priv_mansion = {
        name = "豪宅清空仓",
        desc = "顶级别墅整宅清场后的存货仓，定制家具、艺术挂画与名牌家居用品按房间分区打包，成色近新",
        icon = "image/icon_priv_mansion.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 10, 15, 26, 28, 21 },
        categoryWeights = { art = 32, daily = 25, jewel = 22, antique = 12, fashion = 9 },
    },
    priv_jet = {
        name = "私人机库附属储物间",
        desc = "停用私人飞机库旁的附属仓，飞行装备、高端旅行箱包与机载娱乐设备整齐码放，均为原装封存",
        icon = "image/icon_priv_hangar.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 12, 16, 27, 27, 18 },
        categoryWeights = { transport = 38, mechanical = 25, tech = 20, fashion = 10, daily = 7 },
    },
    priv_trust = {
        name = "离岸信托托管仓",
        desc = "境外信托机构委托清算的资产封存仓，委托人离世或失联后转入拍卖程序，藏品均有完整来源证明",
        icon = "image/icon_priv_trust.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 10, 14, 24, 28, 24 },
        categoryWeights = { jewel = 35, antique = 28, art = 25, fashion = 8, daily = 4 },
    },
    priv_wardrobe = {
        name = "顶级私人衣橱",
        desc = "知名时尚人士的私人衣橱移交仓，高定礼服、限量联名款与顶级珠宝配饰按季度归档，件件有据",
        icon = "image/icon_priv_wardrobe.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 15, 20, 28, 25, 12 },
        categoryWeights = { fashion = 52, jewel = 30, art = 10, daily = 5, antique = 3 },
        preferredTags = { streetwear = 2.5 },
    },
    priv_cellar = {
        name = "私人藏酒窖",
        desc = "顶级收藏家的地下酒窖移交仓，跨越数十年的波尔多列级庄与勃艮第特级园整箱封存，附完整品鉴记录",
        icon = "image/icon_priv_cellar.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 18, 22, 28, 22, 10 },
        categoryWeights = { antique = 45, daily = 28, art = 18, jewel = 6, fashion = 3 },
    },
    priv_vault = {
        name = "地下金库",
        desc = "私人定制地下金库整体移交，裸钻、铂金锭与彩色宝石原石按等级分柜存放，附独立鉴定证书",
        icon = "image/icon_priv_vault.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 12, 16, 26, 28, 18 },
        categoryWeights = { jewel = 65, art = 18, antique = 10, fashion = 5, daily = 2 },
    },
    priv_library = {
        name = "私人藏书阁",
        desc = "学者型收藏家的私人藏书阁移交仓，宋版善本、明清手稿与西方古籍初版在恒温环境中完好保存",
        icon = "image/icon_priv_library.png", bg = "image/edited_bg_bondedport_night_20260323131115.jpg",
        sizeWeights = { 12, 16, 26, 28, 18 },
        categoryWeights = { antique = 55, art = 30, jewel = 8, daily = 5, fashion = 2 },
    },
    ...
    cult_museum = {
        ...
        icon = "image/icon_cult_museum.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 15, 18, 25, 26, 16 },
    ...
    cult_auction = {
        ...
        icon = "image/icon_cult_auction.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    cult_antique = {
        ...
        icon = "image/icon_cult_antique.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    cult_luxury = {
        ...
        icon = "image/icon_cult_luxury.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 16, 19, 25, 25, 15 },
        categoryWeights = { art = 30, jewel = 30, antique = 25, fashion = 12, daily = 3 },
        preferredTags = { streetwear = 1.5 },
    },
    cult_gallery = {
        name = "画廊地下储藏室",
        desc = "著名画廊关闭后的地下储藏室，数十幅原作与艺术版画在恒温环境中保存完好，待价而沽",
        icon = "image/icon_cult_gallery.png", bg = "image/bg_oldtown_20260321192643.jpg",
        sizeWeights = { 15, 18, 25, 26, 16 },
    ...
    cult_jewelry = {
        ...
        icon = "image/icon_cult_jewelry.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    cult_watch = {
        ...
        icon = "image/icon_cult_watch.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    cult_wine = {
        ...
        icon = "image/icon_cult_wine.png", bg = "image/bg_oldtown_20260321192643.jpg",
    ...
    sea_unknown = {
        ...
        icon = "image/icon_unknown_warehouse.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
    ...
    sea_archaeology = {
        ...
        icon = "image/icon_sea_archaeology.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
        sizeWeights = { 15, 18, 25, 26, 16 },
        categoryWeights = { antique = 35, art = 25, transport = 12, tech = 15, mechanical = 10, jewel = 3 },
        preferredTags = { maritime = 2.5 },
    },
    sea_wreck = {
        name = "海底沉船文物存放处",
        desc = "深海沉船打捞队的文物存放仓，锈迹斑斑的船锚、铜炮与船货在防腐处理后等待研究和拍卖",
        icon = "image/icon_sea_wreck.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
        sizeWeights = { 14, 17, 25, 27, 17 },
        categoryWeights = { antique = 42, transport = 18, art = 22, jewel = 10, mechanical = 8 },
        preferredTags = { maritime = 3.0 },
    },
    sea_expedition = {
        name = "远洋探险队装备仓",
        desc = "解散远洋探险队留下的全套装备仓，深潜头盔、水下摄影设备与船只零件整装待售",
        icon = "image/icon_sea_expedition.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
    ...
    sea_research = {
        ...
        icon = "image/icon_sea_research.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
        sizeWeights = { 18, 20, 26, 23, 13 },
        categoryWeights = { tech = 35, energy = 28, mechanical = 22, biotech = 10, daily = 5 },
        preferredTags = { research_instrument = 2.0 },
    },
    sea_biology = {
        name = "海洋生物样本冷库",
        desc = "海洋研究机构关闭的冷库，珍稀海洋生物标本、深海鱼类样品与生物提取物分类封存其中",
        icon = "image/icon_sea_biology.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
        sizeWeights = { 20, 22, 26, 20, 12 },
        categoryWeights = { tech = 38, energy = 28, mechanical = 20, biotech = 10, daily = 4 },
        preferredTags = { research_instrument = 1.5 },
    },
    sea_maintenance = {
        name = "深潜设备维修站仓",
        desc = "深潜设备维修站的备件仓，潜水艇密封件、水下焊接设备与高压气罐整齐码放待用",
        icon = "image/icon_sea_maintenance.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
    ...
    sea_minerals = {
        ...
        icon = "image/icon_sea_minerals.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
        sizeWeights = { 18, 20, 26, 23, 13 },
    ...
    sea_harbor = {
        ...
        icon = "image/icon_sea_harbor.png", bg = "image/bg_warehouse_shipwreck_20260328204443.jpg",
        sizeWeights = { 20, 22, 26, 20, 12 },
