...
M.AD_CARD = {
    ...
    DAILY_MILESTONES = {
        { adsRequired = 5,  coins = 1500000, label = "看5次",  ticket = "ticket_commercial", ticketCount = 10 },
        { adsRequired = 10, coins = 2000000, label = "看10次", ticket = "ticket_port",       ticketCount = 10 },
        { adsRequired = 15, coins = 2500000, label = "看15次", ticket = "ticket_techpark",   ticketCount = 10 },
        { adsRequired = 20, coins = 3000000, label = "看20次", ticket = "ticket_culture",    ticketCount = 10 },
        { adsRequired = 25, coins = 4000000, label = "看25次", ticket = "ticket_deepsea",    ticketCount = 10 },
        { adsRequired = 30, coins = 5000000, label = "看30次", ticket = "ticket_private",    ticketCount = 10 },
    },
}
