...
Tech.items = {
    ...
    { name = "爱迪生留声机部件",     rows = 1, cols = 2, quality = "red", value = 122793,   weight = 12,  desc = "疑似爱迪生实验室的蜡筒留声机零件", image = IMG .. "科技/爱迪生留声机部件.png" },
    { name = "达芬奇手稿残页",       rows = 1, cols = 1, quality = "red", value = 646139,   weight = 5,   desc = "疑似达芬奇设计的机械装置草图残页", image = IMG .. "科技/达芬奇手稿残页.png" },
    { name = "老式相机",             rows = 1, cols = 1, quality = "purple", value = 3334,  weight = 4,   desc = "海鸥牌120胶片相机，镜头有霉丝",   image = IMG .. "科技/老式相机.png" },
    { name = "老天文台时钟",         rows = 2, cols = 2, quality = "red", value = 260582,   weight = 8,   desc = "天文台标准时钟机芯，精度极高",     image = IMG .. "科技/老天文台时钟.png" },
    { name = "早期X光管",            rows = 1, cols = 2, quality = "red", value = 60493,    weight = 15,  desc = "20世纪初的玻璃X光真空管，完好罕见", image = IMG .. "科技/早期X光管.png" },
    -- 紫（补充）
