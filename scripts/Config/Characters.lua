...
M.CHARACTERS = {
    ...
    -- ========== 白凌霄 — 通才 · 开场博览+持续 · 甜妹 · 锁定 ==========
    {
        ...
        ability = "开场博览",
        desc = "拍卖开始时：鉴别随机5件物品的品质\n第2轮起每轮：鉴别随机2件物品的品质",
        specialty = nil,
        locked = true,
        unlockCost = 30,
        revealEvents = {
            { trigger = "round_1",      target = "random_5", category = nil, level = "L2" },
    ...
    -- ========== 江识玉 — 珠宝+全场最优 · 双向侦查 ==========
    {
        ...
        ability = "双向侦查",
        desc = "第1轮：鉴别全场品质最高的1件藏品，并看到珠宝中随机4件的轮廓",
        specialty = "jewel",
        locked = true,
        unlockCost = 30,
        revealEvents = {
            { trigger = "round_1", target = "highest_1",         category = nil,    level = "L2" },
    ...
    -- ========== 贺明珏 — 珠宝专精 · 开场全览 ==========
    {
        ...
        revealEvents = {
            ...
            { trigger = "round_1", target = "category_all", category = "jewel", level = "L1" },
        },
        personality = {
            style = "specialist",
    ...
    -- ========== 谢怀仁 — 医疗专精 · 开场+持续渗透 ==========
    {
        ...
        ability = "医眼如炬",
        desc = "每轮：看到医疗中随机2件的轮廓\n第5轮：鉴别全部医疗的品质",
        specialty = "biotech",
        locked = true,
        unlockCost = 30,
        revealEvents = {
            { trigger = "every_round", target = "category_random_2", category = "biotech", level = "L1" },
