...
M.CHARACTERS = {
    ...
    -- ========== 吴鉴之 — 跨品类 · 品质导向 ==========
    {
        ...
        unlockCost = 30,
        revealEvents = {
            { trigger = "round_1", target = "all", rarity = {"white","green","blue"}, level = "L2_hint" },
    ...
    -- ========== 谢怀仁 — 医疗专精 · 开场+持续渗透 ==========
    {
        ...
        revealEvents = {
            ...
            { trigger = "from_round_2", target = "category_random_2", category = "biotech", level = "L1" },
        },
        personality = {
            style = "grower",
